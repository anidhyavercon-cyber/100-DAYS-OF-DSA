Problem1:Find the Lowest Common Ancestor (LCA) of two nodes in a Binary Tree.
Input Format:
...
Problem2:Given a binary tree, find the lowest common ancestor (LCA) of two given nodes in the tree.
